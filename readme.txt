...
Your cdc/acm serial port USB device must not be claimed by usbser.sys or any other function driver, or you will get an access denied error.

You may need to edit the default endpoint numbers and vendorId/productId.
